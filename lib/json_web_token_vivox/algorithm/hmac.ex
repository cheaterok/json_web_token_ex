defmodule JsonWebTokenVivox.Algorithm.Hmac do
  @moduledoc """
  ...
  ## Example
      ...
      ...> JsonWebTokenVivox.Algorithm.Hmac.sign(:sha256, shared_key, "signing_input")
  ...
  ## Example
      ...
      ...> JsonWebTokenVivox.Algorithm.Hmac.verify?(mac, :sha256, shared_key, "signing_input")
      true
  """
